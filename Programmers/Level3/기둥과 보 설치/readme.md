...
build_frame의 명령어를 따라 수행하며, 수행한 뒤 주어진 조건과 비교하여 맞지 않으면 무시하는 방식으로 최종 건물을 완성하고, x, y, 기둥, 보 순으로 정렬해서 반환하면 되겠다.


***
문제 링크: [링크](https://school.programmers.co.kr/learn/courses/30/lessons/60061)
